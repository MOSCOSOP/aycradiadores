...
export function GuiaPrintTemplate({ data, pageSize = "A4", printId = "doc-print-area" }: GuiaPrintTemplateProps) {
  ...
  const sunatPayload = buildGuiaQrPayload({
  ...
  const qrUrl = sunatQrImageUrl(qrPayload, pageSize === "A5" ? 130 : 160);
          ...
          <div className="doc-print-header-main">
            ...
            <div className="doc-print-header-center">
              ...
              <div className="doc-print-contact">
                ...
                <p className="doc-print-meta">
                  Correo elec: <span className="doc-print-email">{COMPANY_INFO.email}</span>
                </p>
