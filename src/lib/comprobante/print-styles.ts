...
export const COMPROBANTE_PRINT_CSS = `
  * { box-sizing: border-box; }
  ...
  .doc-print-header-body { display: grid; grid-template-columns: minmax(200px, auto) minmax(0, 1fr) 182px; gap: 6px; align-items: start; }
  .doc-print-a5 .doc-print-header-body { grid-template-columns: minmax(168px, auto) minmax(0, 1fr) 148px; gap: 4px; }
  .doc-print-header-left { display: flex; align-items: flex-start; gap: 2px; flex-shrink: 0; }
  .doc-print-logo-wrap { flex-shrink: 0; width: 130px; text-align: center; }
  .doc-print-logo { width: 124px; height: 124px; object-fit: contain; display: block; margin: 0 auto; }
  .doc-print-sello-wrap { flex-shrink: 0; width: 88px; display: flex; align-items: center; justify-content: center; padding-top: 4px; }
  .doc-print-sello { width: 82px; height: auto; max-height: 88px; object-fit: contain; }
  ...
  .doc-print-titulo { display: block; width: auto; max-width: 92%; height: auto; max-height: 48px; object-fit: contain; margin: 0 auto; }
  .doc-print-a5 .doc-print-titulo { max-height: 40px; }
  ...
  .doc-print-totals-table { width: 100%; border-collapse: collapse; font-size: 9px; border: 1px solid #bbb; border-radius: 4px; overflow: hidden; }
  ...
  .doc-print-brands { display: flex; justify-content: space-between; align-items: center; gap: 8px; margin: 14px 0 10px; padding: 0 2px; }
